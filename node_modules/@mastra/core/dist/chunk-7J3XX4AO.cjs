...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      ...
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-TX6V7SJJ.cjs');
...
var gateways = [new chunk3JX2Y3WH_cjs.NetlifyGateway(), new chunkLZUSZT7R_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
