...
async function getInputOptions(entryFile, analyzedBundleInfo, platform, env = { "process.env.NODE_ENV": JSON.stringify("production") }, {
  ...
  const normalizedEntryFile = chunkWVZENB5V_cjs.slash(entryFile);
  return {
    ...
    plugins: [
      ...
      alias__default.default({
        entries: [
          {
            find: /^\#server$/,
            replacement: chunkWVZENB5V_cjs.slash(url.fileURLToPath(undefined("@mastra/deployer/server")))
          },
          {
            find: /^\@mastra\/server\/(.*)/,
      ...
      chunkWVZENB5V_cjs.removeDeployer(entryFile, { sourcemap }),
...
//# sourceMappingURL=chunk-NMOPG6KM.cjs.map
//# sourceMappingURL=chunk-NMOPG6KM.cjs.map